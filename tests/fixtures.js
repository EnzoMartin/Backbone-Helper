...
BB.model_definitions.ship = Backbone.Model.extend({});
...
BB.collection_definitions.ships = Backbone.Collection.extend({
    model: function (attributes,options) {
        return new BB.model_definitions.ship(attributes,options);
    }
});
